...
# La estructura es: temperaturas[ciudad][semana][día]
temperaturas = [
    [   # Ciudad A
        [ {"day": "Lunes", "temp": 25},
          {"day": "Martes", "temp": 27},
...
# Lista de nombres de ciudades correspondiente a la matriz
...
for idx_ciudad, ciudad in enumerate(temperaturas):
    ...
    for idx_semana, semana in enumerate(ciudad):
        # Suma las temperaturas de todos los días de la semana usando comprensión de listas
